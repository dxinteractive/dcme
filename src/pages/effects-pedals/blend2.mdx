...
Only use this as a rough inspiration. [Here's the code I wrote to go with it](https://github.com/dxinteractive/blend2). I change this every now and then, and parts of it are *very* specific to my pedalboard so once again this is provided more for inspiration.
