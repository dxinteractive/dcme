...
export const Box = styled.div({display: 'block'}, space, color, layout, flexbox, position);
export const Flex = styled.div({display: 'flex'}, space, color, layout, flexbox, position);
